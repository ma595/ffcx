...
FORMAT_TEMPLATE = {
    "ufc comment":
    """\
// This code conforms with the UFC specification version
// automatically generated by FFCX version {ffcx_version}.
""",
    "dolfinx comment":
    """\
// This code conforms with the UFC specification version
...
def _generate_comment(parameters):
    ...
    comment = FORMAT_TEMPLATE["ufc comment"].format(ffcx_version=FFCX_VERSION)
